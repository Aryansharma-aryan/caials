...
export default function TopHeader() {
  return (
    <div className="bg-gradient-to-r from-black via-gray-900 to-black text-white text-sm md:text-base px-4 md:px-16 py-3 flex flex-col md:flex-row items-center justify-between gap-3">
      {/* Left - Contact Info */}
